...
object Project1 {
	...
	def main(args: Array[String]) {
		...
		val appleFile = "hdfs://clnode163.clemson.cloudlab.us:8020/p1/q9/enwiki-20110115-pages-articles_whole.xml" // Should be some file on your system
...
//                df4.write.option("sep","\t").csv("alluxio://clnode163.clemson.cloudlab.us:19998/out_8/")
		df4.write.option("sep","\t").csv("hdfs://clnode163.clemson.cloudlab.us:8020/p1/out9/")
	//	df4.write
